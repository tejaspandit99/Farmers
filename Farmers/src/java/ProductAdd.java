...
public class ProductAdd extends HttpServlet {
   ...
   @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (part != null) {
            try {
                PreparedStatement pst = con.prepareStatement("insert into products(image,product_name,price,Bid_value,adharcard,category,endtime,Quantity) values(?,?,?,?,?,?,?,?)");
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        resp.sendRedirect("product_form.html"); //To change body of generated methods, choose Tools | Templates.
    }
